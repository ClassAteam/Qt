...
{
    consumers.append(sngElConsDir(10.0, sngElConsDir::shal, "por1kz", &por1kz));
    consumers.append(sngElConsDir(10.0, sngElConsDir::shal, "prr1kz", &prr1kz));
    consumers.append(sngElConsDir(10.0, sngElConsDir::shal, "psr1kz", &psr1kz));
    consumers.append(sngElConsDir(10.0, sngElConsDir::shal, "por1kpr", &por1kpr));
    consumers.append(sngElConsDir(10.0, sngElConsDir::shal, "prr1kpr", &prr1kpr));
    consumers.append(sngElConsDir(10.0, sngElConsDir::shal, "psr1kpr", &psr1kpr));
    consumers.append(sngElConsDir(10.0, sngElConsDir::shal, "por1kpchk", &por1kpchk));
    consumers.append(sngElConsDir(10.0, sngElConsDir::shal, "prr1kpchk", &prr1kpchk));
    consumers.append(sngElConsDir(30.0, sngElConsDir::shal, "k4_4940", &k4_4940));
    consumers.append(sngElConsDir(30.0, sngElConsDir::shal, "s1_4940", &s1_4940));
    consumers.append(sngElConsDir(3.0, sngElConsDir::shal, "prn1gs1", &prn1gs1));
    consumers.append(sngElConsDir(3.0, sngElConsDir::shal, "prn2gs1", &prn2gs1));
    consumers.append(sngElConsDir(3.0, sngElConsDir::shal, "prn1gs2", &prn1gs2));
    consumers.append(sngElConsDir(3.0, sngElConsDir::shal, "prn2gs2", &prn2gs2));
    consumers.append(sngElConsDir(8.0, sngElConsDir::shal, "pbutzo", &pbutzo));
    consumers.append(sngElConsDir(10.0, sngElConsDir::sh1dpl, "poppd1", &poppd1));
    consumers.append(sngElConsDir(8.0, sngElConsDir::sh1dpl, "gk_avn", &gk_avn));
    consumers.append(sngElConsDir(20.0, sngElConsDir::sh1dpl, "k1_17723", &k1_17723));
    consumers.append(sngElConsDir(5.0, sngElConsDir::sh1dpl, "s1_11028", &s1_11028));
    consumers.append(sngElConsDir(5.0, sngElConsDir::sh1dpl, "s1_11313", &s1_11313));
    consumers.append(sngElConsDir(10.0, sngElConsDir::sh2dpl, "k1_2250", &k1_2250));
    consumers.append(sngElConsDir(5.0, sngElConsDir::sh2dpl, "s1_11052", &s1_11052));
    consumers.append(sngElConsDir(35.0, sngElConsDir::sh2dpl, "k14_2420", &k14_2420));
    consumers.append(sngElConsDir(35.0, sngElConsDir::sh2dpl, "k15_2420", &k15_2420));
    consumers.append(sngElConsDir(15.0, sngElConsDir::sh1l, "k2_7322", &k2_7322));
    consumers.append(sngElConsDir(15.0, sngElConsDir::sh1l, "k9_7322", &k9_7322));
    consumers.append(sngElConsDir(5.0, sngElConsDir::sh1l, "k1_11038", &k1_11038));
    consumers.append(sngElConsDir(7.0, sngElConsDir::sh1l, "s1_11081", &s1_11081));
    consumers.append(sngElConsDir(10.0, sngElConsDir::sh2l, "k3_2250", &k3_2250));
    consumers.append(sngElConsDir(10.0, sngElConsDir::sh2l, "poppd3", &poppd3));
    consumers.append(sngElConsDir(7.0, sngElConsDir::sh2l, "k3_3650", &k3_3650));
    consumers.append(sngElConsDir(15.0, sngElConsDir::sh2l, "k4_7322", &k4_7322));
    consumers.append(sngElConsDir(15.0, sngElConsDir::sh2l, "k11_7322", &k11_7322));
    consumers.append(sngElConsDir(15.0, sngElConsDir::sh2l, "r865gd", &r865gd));
    consumers.append(sngElConsDir(10.0, sngElConsDir::sho1l, "k5_2250", &k5_2250));
    consumers.append(sngElConsDir(7.0, sngElConsDir::sho1l, "y1_3650", &y1_3650));
    consumers.append(sngElConsDir(7.0, sngElConsDir::sho1l, "y2_3650", &y2_3650));
    consumers.append(sngElConsDir(7.0, sngElConsDir::sho2l, "k1_17723", &k1_17723));
    consumers.append(sngElConsDir(15.0, sngElConsDir::shap, "k7_2420", &k7_2420));
    consumers.append(sngElConsDir(15.0, sngElConsDir::shap, "k8_2420", &k8_2420));
    consumers.append(sngElConsDir(10.0, sngElConsDir::shap, "por2kz", &por2kz));
    consumers.append(sngElConsDir(10.0, sngElConsDir::shap, "prr2kz", &prr2kz));
    consumers.append(sngElConsDir(10.0, sngElConsDir::shap, "psr2kz", &psr2kz));
    consumers.append(sngElConsDir(10.0, sngElConsDir::shap, "por2kpr", &por2kpr));
    consumers.append(sngElConsDir(10.0, sngElConsDir::shap, "prr2kpr", &prr2kpr));
    consumers.append(sngElConsDir(10.0, sngElConsDir::shap, "psr2kpr", &psr2kpr));
    consumers.append(sngElConsDir(10.0, sngElConsDir::shap, "por2kpchk", &por2kpchk));
    consumers.append(sngElConsDir(10.0, sngElConsDir::shap, "prr2kpchk", &prr2kpchk));
    consumers.append(sngElConsDir(3.0, sngElConsDir::shap, "prn1gs3", &prn1gs3));
    consumers.append(sngElConsDir(3.0, sngElConsDir::shap, "prn2gs3", &prn2gs3));
    consumers.append(sngElConsDir(3.0, sngElConsDir::shap, "prn1gs4", &prn1gs4));
    consumers.append(sngElConsDir(3.0, sngElConsDir::shap, "prn2gs4", &prn2gs4));
    consumers.append(sngElConsDir(12.0, sngElConsDir::shap, "gk_avl", &gk_avl));
    consumers.append(sngElConsDir(12.0, sngElConsDir::shap, "gk_avp", &gk_avp));
    consumers.append(sngElConsDir(10.0, sngElConsDir::shap, "k18_7322", &k18_7322));
    consumers.append(sngElConsDir(10.0, sngElConsDir::sh1dpp, "k11_2250", &k11_2250));
    consumers.append(sngElConsDir(9.0, sngElConsDir::sh1dpp, "poppd2", &poppd2));
    consumers.append(sngElConsDir(8.0, sngElConsDir::sh1dpp, "pbutzr", &pbutzr));
    consumers.append(sngElConsDir(5.0, sngElConsDir::sh2dpp, "s1_11028", &s1_11028));
    consumers.append(sngElConsDir(7.0, sngElConsDir::sh2dpp, "s1_11081", &s1_11081));
    consumers.append(sngElConsDir(5.0, sngElConsDir::sh2dpp, "s2_11052", &s2_11052));
    consumers.append(sngElConsDir(35.0, sngElConsDir::sh2dpp, "k30_2420", &k30_2420));
    consumers.append(sngElConsDir(35.0, sngElConsDir::sh2dpp, "k31_2420", &k31_2420));
    consumers.append(sngElConsDir(15.0, sngElConsDir::sh1p, "k3_7322", &k3_7322));
    consumers.append(sngElConsDir(15.0, sngElConsDir::sh1p, "k8_7322", &k8_7322));
    consumers.append(sngElConsDir(5.0, sngElConsDir::sh1p, "k2_11038", &k2_11038));
    consumers.append(sngElConsDir(10.0, sngElConsDir::sh2p, "k8_2250", &k8_2250));
    consumers.append(sngElConsDir(15.0, sngElConsDir::sh2p, "prsop", &prsop));
    consumers.append(sngElConsDir(15.0, sngElConsDir::sh2p, "k5_7322", &k5_7322));
    consumers.append(sngElConsDir(15.0, sngElConsDir::sh2p, "k10_7322", &k10_7322));
    consumers.append(sngElConsDir(20.0, sngElConsDir::sh2p, "k2_17723", &k2_17723));
    consumers.append(sngElConsDir(2.0, sngElConsDir::sho1p, "f32_3020", &f32_3020));
    consumers.append(sngElConsDir(2.0, sngElConsDir::sho1p, "f319_3020", &f319_3020));
    consumers.append(sngElConsDir(2.0, sngElConsDir::sho1p, "f356_3020", &f356_3020));
    consumers.append(sngElConsDir(2.0, sngElConsDir::sho1p, "f353_3020", &f353_3020));
    consumers.append(sngElConsDir(7.0, sngElConsDir::sho2p, "k1_17723", &k1_17723));
}
