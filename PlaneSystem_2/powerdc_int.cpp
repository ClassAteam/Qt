...
//    createLabelClue(&OtkazGenVsu, "OTKAZ GEN VSU");
    ...
    createRadioButton(&exchange::s16_2430, "akk1", false);
    createRadioButton(&exchange::s16_2430, "akk2", false);
    createRadioButton(&exchange::s16_2430, "avar1", false);
    createRadioButton(&exchange::s16_2430, "avar2", false);
    createRadioButton(&exchange::s16_2430, "sh1lev", false);
    createRadioButton(&exchange::s16_2430, "sh2lev", false);
    createRadioButton(&exchange::s16_2430, "sh1prav", false);
    createRadioButton(&exchange::s16_2430, "sh2prav", true);
    createRadioButton(&exchange::s17_2430, "akk1_rap1", false);
    createRadioButton(&exchange::s17_2430, "akk2_rap2", false);
    createRadioButton(&exchange::s17_2430, "vsu", true);
    ...
    createRedButton(&exchange::s1_2430, "s1_2430");
    createRedButton(&exchange::s2_2430, "s2_2430");
    createRedButton(&exchange::s3_2430, "s3_2430");
    createRedButton(&exchange::s4_2430, "s4_2430");
    createRedButton(&exchange::s5_2430, "s5_2430");
    createRedButton(&exchange::s7_2430, "s7_2430");
    createRedButton(&exchange::s8_2430, "s8_2430");
    createRedButton(&exchange::s9_2430, "s9_2430");
    createRedButton(&exchange::s10_2430, "s10_2430");
    createRedButton(&exchange::s11_2430, "s11_2430");
    createRadioButton(&exchange::s13_2430, "ground", false);
    createRadioButton(&exchange::s13_2430, "air", true);
    createRedButton(&exchange::s14_2430, "s14_2430");
    createRedButton(&exchange::s15_2430, "s15_2430");
    createRedButton(&glviklvsu, "glviklvsu");
    createRedButton(&pvrap1, "pvrap1");
    createRedButton(&pvrap2, "pvrap2");
    createLabelValue(&exchange::usho2l, "usho2l");
    createLabelValue(&exchange::usho1p, "usho1p");
    createLabelValue(&exchange::usho2p, "usho2p");
    createLabelValue(&exchange::ushak1, "ushak1");
    createLabelValue(&exchange::ushak2, "ushak2");
    createLabelValue(&uls27, "uls27");
    createLabelValue(&ups27, "ups27");
    createLabelValue(&exchange::ushzvsu, "ushzvsu");
    createLabelValue(&exchange::ush1dpl, "ush1dpl");
    createLabelValue(&exchange::ush1dpp, "ush1dpp");
    createLabelValue(&exchange::ush1l, "ush1l");
    createLabelValue(&exchange::ush1p, "ush1p");
    createLabelValue(&exchange::ush2dpl, "ush2dpl");
    createLabelValue(&exchange::ush2dpp, "ush2dpp");
    createLabelValue(&exchange::ush2l, "ush2l");
    createLabelValue(&exchange::ush2p, "ush2p");
    createLabelValue(&exchange::ushal, "ushal");
    createLabelValue(&exchange::ushap, "ushap");
    createLabelValue(&ugvsu27, "ugvsu27");
    createLabelValue(&urap1, "urap1");
    createLabelValue(&urap2, "urap2");
    createLabelValue(&exchange::usho1l, "usho1l");
    createLabelValue(&inpp27, "inpp27");
    createLabelValue(&ingvsu_27, "ivsu");
    ...
    createLabelValue(&ing1_27, "ing1_27");
    createLabelValue(&ing2_27, "ing2_27");
    createLabelValue(&ing3_27, "ing3_27");
    createLabelValue(&ing4_27, "ing4_27");
    createLabelValue(&ingvsu_27, "ingvsu_27");
    createLabelValue(&ingrap_27, "ingrap_27");
    ...
    createLabelValue(&urap1, "urap1");
    createLabelValue(&urap2, "urap2");
    createRedButton(&overload_gen1, "overloard gen1");
    createRedButton(&overload_gen2, "overloard gen2");
    createRedButton(&overload_gen3, "overloard gen3");
    createRedButton(&overload_gen4, "overloard gen4");
...
//    createLabelClue(&f28_2420, "f28_2420");
    ...
    createRedButton(&exchange::s1_2420, "s1_2420");
    createRedButton(&exchange::s5_2420, "s5_2420");
    createRedButton(&exchange::s10_2420, "s10_2420");
    createRedButton(&exchange::s13_2420, "s13_2420");
    createRedButton(&exchange::s4_2420, "s4_2420");
    createRedButton(&exchange::s12_2420, "s12_2420");
    createRedButton(&exchange::s8_2420, "s8_2420");
    createRedButton(&exchange::s2_2420, "s2_2420");
    createRedButton(&exchange::s9_2420, "s9_2420");
    ...
    createLabelValue(&exchange::urap, "urap");
    createLabelValue(&exchange::frap, "frap");
    createRedButton(&exchange::s1_7710, "s1_7710");
    createRedButton(&exchange::s2_7710, "s2_7710");
    createRedButton(&exchange::s3_7710, "s3_7710");
    createRedButton(&exchange::s4_7710, "s4_7710");
    createLabelClue(&purglk3, "purglk3");
    createLabelClue(&otk_preobr_pts1, "otk_preobr_pts1");
    createLabelClue(&exchange::s15_2420, "s15_2420");
    ...
    createLabelValue(&exchange::ushpos[0], "ushpos1");
    createLabelValue(&exchange::ushpos[1], "ushpos2");
    createLabelValue(&exchange::upts, "upts");
    createLabelValue(&exchange::uptsP[0], "uptsa");
    createLabelValue(&exchange::uptsP[1], "uptsb");
    createLabelValue(&exchange::uptsP[2], "uptsc");
    createLabelValue(&exchange::fpts, "fpts");
    createRedButton(&otk_preobr_pts1, "otk_preobr_pts1");
    createRedButton(&exchange::s15_2420, "s15_2420");
    ...
    createRedButton(&exchange::s17_2420, "s17_2420");
    createRedButton(&exchange::s18_2420, "s18_2420");
    createRedButton(&exchange::s19_2420, "s19_2420");
    createRedButton(&exchange::s21_2420, "s21_2420");
    createLabelClue(&pbapsh1, "pbapsh1");
    createLabelClue(&pbapsh2, "pbapsh2");
    createLabelClue(&pbapsh3, "pbapsh3");
    ...
    createLabelValue(&exchange::upos, "upos");
    createLabelValue(&exchange::fpos, "fpos");
    createLabelValue(&exchange::ushpP[0][0], "ushp1-a");
    createLabelValue(&exchange::ushpP[1][0], "ushp2-a");
    createLabelValue(&exchange::ushavP[0][0], "ushav1-a");
    createLabelValue(&exchange::ushavP[1][0], "ushav2-a");
    createLabelValue(&exchange::ushavP[2][0], "ushav3-a");
    createLabelValue(&exchange::ushavP[3][0], "ushav4-a");
    createLabelValue(&exchange::ushgP[0][0], "ushg1-a");
    createLabelValue(&exchange::ushgP[1][0], "ushg2-a");
    createLabelValue(&exchange::ushgP[2][0], "ushg3-a");
    createLabelValue(&exchange::ushgP[3][0], "ushg4-a");
    createLabelValue(&exchange::urapP[0], "urap-a");
    createLabelValue(&exchange::ushpos[0], "ushpos1");
    createLabelValue(&exchange::ushpos[1], "ushpos2");
    createLabelValue(&exchange::ushpts[0], "ushpts-a");
    createLabelValue(&exchange::fshg[0], "fshg-1");
    createLabelValue(&exchange::fshg[1], "fshg-2");
    createLabelValue(&exchange::fshg[2], "fshg-3");
    createLabelValue(&exchange::fshg[3], "fshg-4");
    createLabelValue(&exchange::fshg[4], "fshg-5");
    createLabelValue(&exchange::fshp[0], "fshp1");
    createLabelValue(&exchange::fshp[1], "fshp2");
    createLabelValue(&exchange::fshpos[0], "fshpos1");
    createLabelValue(&exchange::fshpos[1], "fshpos2");
    createLabelValue(&exchange::fshav[0], "fshav1");
    createLabelValue(&exchange::fshav[1], "fshav2");
    createLabelValue(&exchange::fshav[2], "fshav3");
    createLabelValue(&exchange::fshav[3], "fshav4");
    for(int i = 0; i < allElConsAlt_inst.consumers.count(); ++i)
    {
        createRedButton(&allElConsAlt_inst.consumers[i]->isActive,
                        allElConsAlt_inst.consumers[i]->name);
    }
