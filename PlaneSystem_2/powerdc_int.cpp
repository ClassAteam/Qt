    ...
    : interfacing(parent)
{
    ...
    createLabelValue(&alt::ug1a, "ug1a");
    createLabelValue(&alt::ug2a, "ug2a");
    createLabelValue(&alt::ug3a, "ug3a");
    createLabelValue(&alt::ug4a, "ug4a");
    createLabelValue(&alt::ugVsuA, "ugVsuA");
    createLabelValue(&alt::ug1b, "ug1b");
    createLabelValue(&alt::ug2b, "ug2b");
    createLabelValue(&alt::ug3b, "ug3b");
    createLabelValue(&alt::ug4b, "ug4b");
    createLabelValue(&alt::ugVsuB, "ugVsuB");
    createLabelValue(&alt::ug1c, "ug1c");
    createLabelValue(&alt::ug2c, "ug2c");
    createLabelValue(&alt::ug3c, "ug3c");
    createLabelValue(&alt::ug4c, "ug4c");
    createLabelValue(&alt::ugVsuC, "ugVsuC");
...
//    createLabelClue(&f28_2420, "f28_2420");
    ...
    createLabelValue(&ushp1a, "ushp1a");
    createLabelValue(&ushp1b, "ushp1b");
    createLabelValue(&ushp1s, "ushp1s");
    createLabelValue(&ushavpp, "ushavpp");
    createLabelValue(&upts, "upts");
    createLabelValue(&uptsa, "uptsa");
    createLabelValue(&uptsb, "uptsb");
    createLabelValue(&uptss, "uptss");
    createLabelValue(&ushavla, "ushavla");
    createLabelValue(&ushavlb, "ushavlb");
    createLabelValue(&ushavls, "ushavls");
    createLabelValue(&ushavpa, "ushavpa");
    createLabelValue(&ushavpb, "ushavpb");
    createLabelValue(&ushavps, "ushavps");
