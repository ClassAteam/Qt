...
//{
//    double* U1_pool[] = {&powerdc_inst.ush1dpl, &powerdc_inst.ush1dpl, &powerdc_inst.ush1dpp, &powerdc_inst.ush1dpp};
//    double* U2_pool[] = {&powerdc_inst.ushavP[2][0], &powerdc_inst.ushavP[2][0],
//                         &powerdc_inst.ushavP[2][0], &powerdc_inst.ushavP[2][0]};
...
//    double* Ushal_pool[] = {&powerdc_inst.ushal, &powerdc_inst.ushal,
//                            &powerdc_inst.ushap, &powerdc_inst.ushap};
...
//    if(powerdc_inst.usho1l >= 18.0 && F14_2930 == true)
//    {
//        PK = true;
//    }
...
//    if(powerdc_inst.usho1l >= 18.0 && F14_2930 == true && S13_2920 == true)
//    {
//        PKL1 = true;
//    }
//    else
